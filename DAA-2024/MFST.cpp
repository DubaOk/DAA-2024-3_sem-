			...
			case LENTA_END:
				MFST_TRACE4("------>LENTA_END")
					if (st.top() == '$') {
						#ifdef BLANC
						cout << "**************************************************************************" << endl;
						sprintf_s(buf, MFST_DIAGN_MAXSIZE, "%d всего строк %d, лексический и синтаксический анализ выполнен без ошибок", 0, lenta_size);
						cout << setw(4) << left << 0 << ": всего строк - " << lenta_size << ", лексичесикй,		 синтаксический анализ выполнен без ошибок" << endl;
						cout << "**************************************************************************" << endl;
						#endif
						rc = true;
					}
